...
\begin{frame}
    ...
    \scriptsize
    \onslide<2->{
        \begin{block}[Indice de Tippett{,} ou TCS (Tippet{,} Camargo{,} et Sobel{,} 2011)]
            \begin{equation*}
    ...
    \onslide<2->{
        ...
        \begin{center}
            \begin{minipage}{9cm}
                \begin{alertblock}
                    \centering
                    On atteint les limites de ce que ces indices peuvent faire pour la variabilité interannuelle
                \end{alertblock}
            \end{minipage}
        \end{center}
    }
