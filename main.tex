...
\begin{frame}
    \frametitle{Les modèles de climat}
    \framesubtitle{ARPEGE et ERA5}

    Je penche de plus en plus vers une slide supplémentaire ici pour introduire brièvement la distinction modèle climat / réanalyse, i.e ARPEGE / ERA5.
...
\begin{frame}[t]
    ...
    \begin{block}[Étapes de détection \parencite{chauvin_response_2006}] 
        ...
        \begin{enumerate}
            ...
            \item \textcolor{violet}{Relaxation} des paramètres pour \underline{compléter} en amont et en aval (\textbf{REL})
        \end{enumerate}
    \end{block}
    %\vspace{1em}
    \begin{figure}
