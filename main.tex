...
\begin{frame}[c]
    ...
    \begin{columns}
        ...
        \begin{column}{0.33\textwidth}
            ...
            %     \centering
            %     \transduration<0-27>{5}
            %     \multiinclude[<+->][format=png, graphics={width=4cm}]{Figures/Ophelia/msl/ophelia-msl}
            %     \caption{Animation du cyclone Ophelia (2017) sur fond de \alert{pression au niveau de la mer} (ERA5)}
            % \end{figure}
        \end{column}
    \end{columns}
\end{frame}
