...
\begin{frame}[c]
    ...
    \framesubtitle{Pourquoi s'intéresser à ERA5}
...
\begin{frame}[t]
    ...
    \begin{block}[Étapes de détection \parencite{chauvin_response_2006}] 
        \scriptsize
        \begin{enumerate}
            \item \textcolor[HTML]{ff0011}{Seuil} de vorticité (\textbf{VOR})
        ...
        \begin{column}{0.6\textwidth}
            ...
            \onslide<2->{
                ...
                \begin{block}[Appariement des trajectoires]
                    ...
                    \begin{enumerate}
                        \item Recherche des candidats IBTrACS par correspondance spatio-temporelle
                        \item Score basé sur la quantité de points en commun à moins de 300 km
                        \item Sélection de la paire de trajectoires avec le meilleur score
                    \end{enumerate}
            ...
            \onslide<3->{
                \scriptsize
                \begin{definition}
                    Seuils de détection du traqueur qui optimisent le POD et le FAR sur ERA5 :\\
    ...
    \begin{columns}
        \begin{column}{0.5\textwidth}
           ...
           \begin{itemize}
               ...
               \item Définition de $C \cap Q$, $C \ominus N$ et aussi de $C \cup Q$
           \end{itemize}
        \end{column}
        \begin{column}{0.5\textwidth}
           \begin{figure}
...
\begin{frame}[c]
    ...
    Introduction des trois métriques : MAS$^\cap$, MAS$^\cup$ et wMAS
    %\vskip0ptplus1filll\relax
    \vspace{2em}
    \begin{figure}
        \centering
        \includegraphics[width=\textwidth]{Figures/MAS_vs_Ndiff.png}
    \end{figure}
\end{frame}
...
\begin{frame}[c]
    ...
    Introduire la situation :
    \begin{itemize}
        \item Deux jeux de trajectoires ERA5 à différents paramètres seuils
        \item Les deux jeux sont appariés à IBTrACS : 2 trajectoires ERA5 pour chaque trajectoire IBTrACS
    \end{itemize}
    %
    \begin{center}
        \includegraphics[width=0.7\textwidth]{Figures/delta_MAS.png}
    \end{center}
    %
    (Il faudra peut-être deux slides pour présenter le cas d'étude + résultats)
\end{frame}

\section{Construction d'indices de cyclogénèse}
