    ...
    \begin{columns}
        \begin{column}{0.65\textwidth}
            \begin{figure}[h]
                ...
                \caption{\scriptsize Données issues de la base de données de cyclones IBTrACS, version 4}
            \end{figure}
        \end{column}
...
\begin{frame}[c]
    \frametitle{Qu'est-ce qu'un cyclone tropical ?}
    \framesubtitle{Conditions de formation}
    \begin{figure}[h]
        \centering
        ...
        \onslide<1->{
            \begin{column}{0.45\textwidth}
                \begin{figure}[t]
                    ...
                    \caption{\scriptsize Illustration schématique du maillage tridimensionnel d'un modèle de climat. Les couleurs représentent la température et les flèches
                    ...
                    \onslide<4->{
                        \begin{alertblock}[Inconvénients] 
                            ...
                            \begin{itemize}
                                ...
                                \vspace{2.9ex}
                                \item Influence du choix du traqueur \parencite{horn_tracking_2014,roberts_impact_2020}
                            \end{itemize}
                        \end{alertblock}
                    }
                \end{column}
    ...
    \begin{columns}[t]
        \begin{column}{0.66\textwidth}
            \begin{definition}
                \scriptsize
                %\centering
                \underline{Fréquence d'occurrence} de la cyclogénèse en un point de grille proportionnelle à une \mbox{combinaison} de variables \alert{thermiques} et
    ...
    \begin{columns}[b]
        ...
        \begin{column}{0.5\textwidth}
            \begin{figure}[h]
                ...
                \caption{\scriptsize Changement dans la densité de cyclogénèse (par 50 ans) par mesure \mbox{\alert{indirecte}} (GPI) sur la période 2031 --
       ...
       \begin{column}{0.475\textwidth}
           ...
           \onslide<3->{
               \begin{examples}[Axe de recherche]
                   Caractériser en détail le schéma de détection du CNRM pour identifier des pistes de perfectionnement
               \end{examples}
           }
           \vspace{1em}
           \onslide<4->{
           ...
           \onslide<5->{
               \begin{alertblock}[Verrous identifiés]
                   ...
                   \begin{itemize}
                       ...
                       \item Mauvaise représentation de la variabilité interannuelle \parencite{menkes_comparison_2012,cavicchia_tropical_2023a}
                   \end{itemize}
               \end{alertblock}
           }
           \vspace{1em}
        ...
        \begin{column}{0.6\textwidth}
            ...
            \onslide<2->{
                ...
                \begin{block}[Appariement des trajectoires]
                    ...
                    \textbf{Note} : La méthodologie autorise des paires avec une seule échéance commune 
                    \vspace{-1em}
                \end{block}
            }
            \vspace{1em}
        ...
        \onslide<2->{
            \begin{column}{0.4\textwidth}
                ...
                \begin{figure}
                    ...
                    \caption{\scriptsize Ouragan Katrina (2005) observé (rouge) et détecté dans ERA5 (bleu), résultant de l'appariement des trajectoires.}
                \end{figure}
            \end{column}
        }
    \end{columns} 
...
\begin{frame}
    ...
    \begin{columns}
        ...
        \begin{column}{0.5\textwidth}
            ...
            \begin{block}
                \begin{itemize}
                    \item \alert{Forte sous-estimation} des vents maximum dans ERA5, compte tenu de la résolution \parencite{davis_resolving_2018}
        ...
        \begin{column}{0.5\textwidth}
            \onslide<1->{
                \begin{block}
                    ...
                    \end{itemize}
                    \tcblower
                    $\longrightarrow$ Amélioration de la similarité par \alert{réduction} de la différence de temporalité
                \end{block}
            }
        \end{column}
        \begin{column}{0.5\textwidth}
    ...
    \begin{block}[Messages clefs]
        ...
        \begin{enumerate}
            ...
            \item<2-> Distinction des métriques selon leur comptabilisation des échéances non communes\\
                $\longrightarrow$ Peuvent être utilisées de manière complémentaire
    ...
    \begin{columns}
        \begin{column}{0.7\textwidth}
            ...
            \begin{definition}[Définition]
                ...
                \end{align*}
                Constitués d'une composante \textcolor{red}{thermique}, d'une composante \textcolor{violet}{dynamique} et \textcolor{green}{calibrés} pour simuler la
...
\begin{frame}[c]
    ...
    \begin{definition}[Régression de Poisson]
        ...
        %
        \begin{itemize}
            \item Prédictant y : Densité de cyclogénèse issue des trajectoires, de taille \alert{$m = N_{\text{lat}} \times N_{\text{lon}} \times N_{\text{temps}}$}
    ...
    \begin{block}[Détection et suivi]
        ...
        \begin{itemize}
            ...
            \item<2-> Confrontation des traqueurs \textquote{physiques} à des traqueurs IA
                \parencite{racah_extremeweather_2017,kumler-bonfanti_tropical_2020,galea_tcdetect_2023}
                \begin{itemize}
...
\begin{frame}[c]
    ...
    \begin{figure}
        \centering
        \includegraphics[width=\textwidth]{Figures/Annexes/optimisation_vectors.png}
...
%=========================================================
\begin{frame}[c]
    \frametitle{Corrélation des solutions entre les bassins}
    \begin{figure}
        \centering
        \includegraphics[width=0.8\textwidth]{Figures/Annexes/FigA2.png}
    \end{figure}
\end{frame}
...
\begin{frame}[c]
    \frametitle{Distribution des max intervenant dans les composites}
    \begin{figure}
        \centering
        \includegraphics[width=0.8\textwidth]{Figures/Annexes/FigB6.png}
    \end{figure}
\end{frame}
%=========================================================
\begin{frame}[t]
    \frametitle{Composites de la structure interne des TC dans ERA5}
    \framesubtitle{Classes d'intensité ERA5}
    \begin{figure}
        \centering
        \includegraphics[width=0.95\textwidth]{Figures/Annexes/composites_corrected_scale.png}
        \caption{\small Composites moyennés par classe d'intensité ERA5 (correction quantile-quantile)}
    \end{figure}
\end{frame}
...
\begin{frame}[c]
    \frametitle{Variabilité ERA5 / IBTrACS}
    \begin{figure}
        \centering
        \includegraphics[width=0.9\textwidth]{Figures/Annexes/variabilite_ERA5_IBTrACS.png}
    \end{figure} 
\end{frame}

\subsection*{Fausses alarmes ERA5}
\begin{frame}[c]
    \frametitle{Saisonalité des faux positifs}
    \begin{figure}
        \centering
        \includegraphics[width=\textwidth]{Figures/Annexes/fp_seasonality_basin.pdf}
    \end{figure}
\end{frame}

\begin{frame}[c]
    \frametitle{Latitude des faux positifs}
    \begin{figure}
        \centering
        \includegraphics[width=\textwidth]{Figures/Annexes/fp_lat_density_basin.pdf}
    \end{figure}
\end{frame}

%=========================================================
\subsection*{Indices dans la littérature}
\begin{frame}[c]
    \frametitle{Indices de la littérature : TCS, CYGP et GPI}
    \framesubtitle{Cyclone annuel}
    \begin{figure}
        \centering
        \includegraphics[width=0.8\textwidth]{Figures/Annexes/tcs_cygp_gpi_ibt_clim_mensuel.png}
    \end{figure} 
\end{frame}
...
\begin{frame}[c]
    \frametitle{Indices de la littérature : TCS, CYGP et GPI}
    \framesubtitle{Distribution méridienne}
    \begin{figure}
        \centering
        \includegraphics[width=0.8\textwidth]{Figures/Annexes/tcs_cygp_gpi_ibt_zonal_sum_1981_2019.png}
    \end{figure} 
\end{frame}
...
\begin{frame}[c]
    \frametitle{Indices de la littérature : TCS, CYGP et GPI}
    \framesubtitle{Variabilité interannuelle}
    \begin{figure}[htpb]
        \centering
        \includegraphics[width=0.8\textwidth]{Figures/Annexes/tcs_cygp_gpi_interannual.png}
    \end{figure}
\end{frame}
