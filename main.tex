...
\begin{frame}[t]
    ...
    \begin{block}[Étapes de détection \parencite{chauvin_response_2006}] 
        \scriptsize
        \begin{enumerate}
            \item<1-> Minimum local de pression avec vorticité supérieure à un \textcolor[HTML]{ff0011}{seuil} (\textbf{VOR})
...
%=========================================================
\begin{frame}[c]
    \frametitle{Diapo vide}
    Diapo supprimée, page vide pour préserver la numérotation
...
\begin{frame}[t]
    ...
    \begin{columns}[t]
        ...
        \begin{column}{0.33\textwidth}
            ...
            \begin{figure}
                \centering
                \includegraphics<1>[width=0.9\textwidth]{Figures/exemple_similarite/step1.png}%
                \includegraphics<2>[width=0.9\textwidth]{Figures/exemple_similarite/step2.png}%
                \includegraphics<3->[width=0.9\textwidth]{Figures/exemple_similarite/step3.png}%
            \end{figure}
        \end{column}
    \end{columns}
    \vspace{-0.5em}
    \begin{figure}
        \centering
        \includegraphics<1>[height=3.5cm]{Figures/MAS_vs_NDIFF/step1.png}%
        \includegraphics<2>[height=3.5cm]{Figures/MAS_vs_NDIFF/step2.png}%
        \includegraphics<3->[height=3.5cm]{Figures/MAS_vs_NDIFF/step3.png}%
    \end{figure}
\end{frame}
    ...
    \onslide<3->{
        \begin{block}[Indices construits]
            ...
            \begin{itemize}
                ...
                \item Champs \alert{mensuels} ($N_\text{temps} = 480$) (2,5°~km / 1,0°) : \textbf{M25} / \textbf{M10}
            \end{itemize}
            \tcblower
