        ...
        \begin{column}{0.6\textwidth}
            ...
            \onslide<3->{
                ...
                \begin{definition}[Optimisation du schéma de détection pour ERA5 \parencite{dulac_assessing_2023}]
                    Seuils de détection du traqueur qui \underline{optimisent} le POD et le FAR sur ERA5 :\\
            ...
            \begin{enumerate}
                \item<2-> Diagnostique du mode de variabilité climatique El Niño (ENSO):
                    \begin{itemize}
                        ...
                        \item Effet \underline{local} de l'ENSO présent dans les indices \parencite{watterson_seasonal_1995}, mais les épisodes sont peu marqués
                    \end{itemize}
            ...
            \begin{itemize}
                \item Utilisation de la réanalyse ERA5 pour évaluer les performances du traqueur contre IBTrACS\\
                    ...
                    \begin{itemize}
                        ...
                        \item Amélioration sensible des performances par l'analyse de la sensibilité du traqueur à ses seuils de détection et l'utilisation de
                            filtres de systèmes de moyennes latitudes adaptés
                        \item Participation à une intercomparaison de traqueurs sur ERA5
                        \item Évaluation de la représentation des cyclones dans ERA5
                    \end{itemize}
            \end{itemize}
        }
    \vspace{2em}
    ...
    \begin{block}[Détection et suivi]
        ...
        \begin{itemize}
            ...
            \item<1-> Poursuivre la recherche de l'amélioration des performances des traqueurs sur des réanalyses, en vue de leur utilisation sur des climatiques
                ...
                \end{itemize}
            \item<2-> Constitution de bases de données \textquote{expertes} de trajectoires sur les ensembles multi-modèles 
                \begin{itemize}
                    \item Ensembles \textquote{multi-traqueurs}
                    \item Constitution de bases de données composites
                \end{itemize}
            \item<3-> Confrontation des traqueurs \textquote{physiques} à des traqueurs IA
                \begin{itemize}
